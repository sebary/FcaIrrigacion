...
```{r AhorroMzaUm, results='asis',fig.show='hold', fig.height=4.5, fig.width=11, fig.cap="\\label{AhorroMzaUm}Curva de ahorro de agua por menores filtraciones",out.extra="", fig.align='center'}
```
...
`r round(OfertaMza$AAcumUm[[1]]/1000, digits=0)` miles de metros cúbicos (m$^3$). 
