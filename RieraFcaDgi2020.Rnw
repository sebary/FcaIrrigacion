...
<< Revestimiento, echo=FALSE, cache=FALSE,warning=FALSE>>=
@
%\end{frame}

%\begin{frame}{Resultados preliminares}
<< DataObrasFull, results='hide', echo=FALSE, cache=FALSE, warning=FALSE>>=
@

<< SumFull, results='hide', echo=FALSE, cache=FALSE,warning=FALSE>>=
@
\end{frame}
...
@ 
\vspace{-.55cm}
<< MzaTablePpt, results='asis', echo=FALSE, cache=FALSE, warning=FALSE, tab.width=12>>=
@ 
\end{frame}

\begin{frame}{Río Mendoza}
<< AhorroMzaPerd, results='asis',fig.show='hold', fig.height=7.8, fig.width=12.5, fig.cap="\\label{AhorroMzaPerd}Curva de ahorro de agua",out.extra="", fig.align='center', warning=FALSE>>=
@
\end{frame}

\begin{frame}{Preliminares: Río Mendoza}
\vspace{-.55cm}
<< MendozaInv, results='asis', echo=FALSE, cache=FALSE, warning=FALSE, tab.width=12>>=
@ 
\end{frame}
...
<<CtoPromedio, results='asis'>>=
CProm
@
/$m^3$

\pause \item Concepto de flujo ($m^3 anual$) = 
<<AhorroCtoPromedio, results='asis'>>=
@
=
<<AhorroPromBis, results='asis'>>=
@
$Hm^3$
\pause \item Concepto de stock ($m^3 perpetuo$) = 
<<AhorroStock, results='asis'>>=
@
=
<<AhorroStockBis, results='asis'>>=
@
$Hm^3$
\end{itemize}
\end{frame}
